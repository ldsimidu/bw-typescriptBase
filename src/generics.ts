...
const firstValueFromStringArray = getFirstValueFromArray<string>(['1', '12']);
const firstValueFromNumberArray = getFirstValueFromArray<number>([1, 12]);
